...
class CardSearchGenericSearchIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldExcludeNameField() throws Exception {
        ...
        var withName = mockMvc.perform(get("/api/pokemon/search")
                        .param("q", "Pikachu"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        var withoutName = mockMvc.perform(get("/api/pokemon/search")
                        .param("q", "Pikachu")
    ...
    void shouldExcludeAttacksField() throws Exception {
        ...
        var withAttacks = mockMvc.perform(get("/api/pokemon/search")
                        .param("q", "Thunderbolt"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        var withoutAttacks = mockMvc.perform(get("/api/pokemon/search")
                        .param("q", "Thunderbolt")
    ...
    void shouldExcludeArtistField() throws Exception {
        ...
        var withArtist = mockMvc.perform(get("/api/pokemon/search")
                        .param("q", "Ken"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        var withoutArtist = mockMvc.perform(get("/api/pokemon/search")
                        .param("q", "Ken")
